...
class CFGenerators:
    def __init__(self, rf, train_set, feature_names, feature_cons=None, dist_type='L2'):
        self.rf = rf
    ...
    def fit(self):
        ...
        self.live_regions_predictions = self.rf.predict((self.live_regions[:,0:-1:2]+self.live_regions[:,1::2])/2)
    ...
    def __interval_dist(self, d, x_d, intervals, dist_type):
        ...
        if dist_type == 'L1':
            ...
            dists = (dists/self.dist_std[d])**2 # not squared
    ...
    def generate_cf(self, x, target, generator='eece', dist_type=None):
        ...
        if cf is None:
            ...
            result['time cost'] = round(end_time-start_time, 4)
